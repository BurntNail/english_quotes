...
use english_quotes::{
    db::{add_quote_to_db, read_db, remove_quote},
...
impl eframe::App for EnglishQuotesApp {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        let vertical_category_checkbox = |ui: &mut Ui, cc: &mut Vec<bool>| {
            ui.vertical(|ui| {
        ...
        let get_chosen_types = |current_checked: Vec<bool>| {
            current_checked
                .into_iter()
                .enumerate()
        ...
        let reverse_chosen_types = |cats: Vec<String>| {
            ...
            CurrentAppState::QuoteCategories => {
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.vertical(|ui| {
                        ...
                        let chosen_quotes = self.current_db.clone().into_iter().filter(|quote| {
                            let mut works = false;
